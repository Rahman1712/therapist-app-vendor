...
public class TherapistPublicController {
...
//	======================
    ...
    @GetMapping("/categories-by-frequency")
    public List<Category> getCategoriesOrderedByFrequency() {
        return categoryService.getCategoriesOrderedByFrequency();
    }
    
    @GetMapping("/therapists/by-category/{categoryName}")
    public List<TherapistUserDto> getTherapistsByCategoryName(@PathVariable String categoryName) {
        return therapistService.getTherapistsByCategoryName(categoryName);
    }
}
